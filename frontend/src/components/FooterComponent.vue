<template>
  ...
  <div id="f_container">
    <div class="container">
      <footer
        class="d-flex flex-wrap justify-content-between align-items-center py-3 my-auto border-top"
      >
        <div class="col-md-4 d-flex align-items-center">
          ...
          >
            <img
              class="bi"
              src="../logo/logo_tr.png"
              alt="Logo personalizado"
              width="40"
              height="40"
            />
          </a>
          <span class="mb-3 mb-md-0 text-body-secondary" id="flogo"
            >© 2023 GPT-GAMES</span
          >
        </div>
